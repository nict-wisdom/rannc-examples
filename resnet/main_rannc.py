...
my_models = ["resnet50x2", "resnet50x4", "resnet50x8",
             "resnet101x2", "resnet101x4", "resnet101x8",
             "resnet152x2", "resnet152x4", "resnet152x8"]
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    try:
        ...
        print("Synchronizing parameters with apex.")
        flat_dist_call([param.data for param in model.parameters()], torch.distributed.broadcast, (0,))
        pyrannc.sync_params_on_init(False)
    except:
        print("RaNNC is synchronizing parameters. Enable apex for more efficient synchronization.")
        pyrannc.sync_params_on_init(True)
...
def train(train_loader, model, criterion, optimizer, epoch, args, global_optimizer_state):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        # We need barrier here for benchmarking.
        # The time for data loading differs across processes.
        pyrannc.barrier()
